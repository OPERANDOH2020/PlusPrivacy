pspApp.controller('DatePickerCtrl', ['$scope', '$mdDialog', 'currentDate', '$mdMedia', function($scope, $mdDialog, currentDate, $mdMedia) {
    var self = this;
...
pspApp.factory("$mdDatePicker", ["$mdDialog", function($mdDialog) {
...
pspApp.directive("input", ["$mdDatePicker", "$timeout", function($mdDatePicker, $timeout) {
    return {
        restrict: 'E',
        require: '?ngModel',
