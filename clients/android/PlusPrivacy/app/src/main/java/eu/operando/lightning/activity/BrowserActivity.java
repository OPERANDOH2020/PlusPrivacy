...
import eu.operando.lightning.interpolator.BezierDecelerateInterpolator;
import eu.operando.lightning.receiver.NetworkReceiver;
import eu.operando.lightning.search.SuggestionsAdapter;
import eu.operando.lightning.utils.DrawableUtils;
import eu.operando.lightning.utils.Preconditions;
import eu.operando.lightning.utils.ThemeUtils;
import eu.operando.lightning.utils.UrlUtils;
import eu.operando.lightning.utils.Utils;
import eu.operando.lightning.utils.WebUtils;
import eu.operando.lightning.view.Handlers;
import eu.operando.lightning.view.LightningView;
import eu.operando.lightning.view.SearchView;
...
public abstract class BrowserActivity extends ThemableBrowserActivity implements BrowserView, UIController, OnClickListener {
    ...
    private synchronized void initialize(Bundle savedInstanceState) {
        ...
        if (mShowTabsInDrawer) {
            ...
            mArrowImage.setImageResource(R.mipmap.ic_launcher);
