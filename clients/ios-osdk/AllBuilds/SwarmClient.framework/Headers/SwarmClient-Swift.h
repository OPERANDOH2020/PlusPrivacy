...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SwarmClient",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
- (void (^ _Nonnull)(uint64_t, void (^ _Nonnull)(NSArray * _Nonnull)))emitWithAck:(NSString * _Nonnull)event with:(NSArray * _Nonnull)items SWIFT_WARN_UNUSED_RESULT;
- (void)engineDidCloseWithReason:(NSString * _Nonnull)reason;
/// error
- (void)engineDidErrorWithReason:(NSString * _Nonnull)reason;
- (void)engineDidOpenWithReason:(NSString * _Nonnull)reason;
