...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="PPCommonUI",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC10PPCommonUI15CommonUIBUilder")
...
SWIFT_CLASS("_TtC10PPCommonUI20CommonUIDisplayModel")
...
SWIFT_CLASS("_TtC10PPCommonUI19PPNibDesignableView")
@interface PPNibDesignableView : UIView
...
SWIFT_CLASS("_TtC10PPCommonUI16SCDSectionHeader")
...
SWIFT_CLASS("_TtC10PPCommonUI25SCDSectionHeaderCallbacks")
...
SWIFT_CLASS("_TtC10PPCommonUI21SCDSectionHeaderModel")
...
@interface UIColor (SWIFT_EXTENSION(PPCommonUI))
+ (UIColor * _Nonnull)colorWith:(float)red :(float)green :(float)blue :(float)alpha SWIFT_WARN_UNUSED_RESULT;
@end


SWIFT_CLASS("_TtC10PPCommonUI28UINotificationViewController")
...
@interface UIViewController (SWIFT_EXTENSION(PPCommonUI))
