...
struct ofile {
    ...
    char	   toc_bad;	    /* the toc needs to be rebuilt */
...
__private_extern__ void ofile_unmap(
    struct ofile *ofile);
__private_extern__  char ofile_first_arch(
    struct ofile *ofile);
__private_extern__  char ofile_next_arch(
    struct ofile *ofile);
__private_extern__  char ofile_first_member(
    struct ofile *ofile);
__private_extern__  char ofile_next_member(
    struct ofile *ofile);
__private_extern__  char ofile_specific_member(
    const char *object_name,
    struct ofile *ofile);
__private_extern__  char ofile_first_module(
    struct ofile *ofile);
__private_extern__  char ofile_next_module(
    struct ofile *ofile);
__private_extern__  char ofile_specific_module(
