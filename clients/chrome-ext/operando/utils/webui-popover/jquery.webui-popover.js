(function(window, document, undefined) {
    ...
    (function(factory) {
        ...
        var defaults = {
            ...
            '<div class="webui-popover-content"><i class="icon-refresh"></i> <p>&nbsp;</p>' +
            '</div>' +
            '<button class="pfbgotit">I got it</button>'+
            '</div>' +
            '</div>',
            backdrop: false,
            dismissible: true,
        ...
        WebuiPopover.prototype = {
            ...
            accept:function(){
               if (this.options.onAccept) {
                    this.options.onAccept(this.$target);
                    this.hide(true);
               }
            },
            ...
            initTargetEvents: function() {
                ...
                this.$target.find('.pfbgotit').off('click').on('click', $.proxy(this.accept, this, true));
