...
#define HUD_SPINNER_COLOR		[UIColor colorWithRed:0.0/255.0 green:183.0/255.0 blue:189.0/255.0 alpha:1.0]
#define HUD_Error_COLOR	        [UIColor colorWithRed:183.0/255.0 green:49.0/255.0 blue:44.0/255.0 alpha:1.0]
...
#define HUD_IMAGE_ERROR			[[UIImage imageNamed:@"progresshud-error"] imageWithRenderingMode:UIImageRenderingModeAlwaysTemplate]
